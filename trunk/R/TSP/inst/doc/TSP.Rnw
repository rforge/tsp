...
object) or a symmetric matrix using a constructor function \func{TSP}
or coercion with \func{as.TSP}.  \class{ATSP} objects are
created by \func{ATSP} or coercion (\code{as.ATSP}) 
from square matrices representing the distances.
...
data given by the species field in the data set.
